...
public:
    ...
    static BOOL GetAttrib(DVXML_NODE *pNode, LPCTSTR lpszAttrName, bool &bReturn);
    ...
    static BOOL GetAttrib(DVXML_NODE *pNode, LPCTSTR lpszAttrName, double &dReturn);

	static BOOL SetAttrib(DVXML_NODE *pNode, LPCTSTR lpszAttrName, LPCTSTR lpszVal);
    static BOOL SetAttrib(DVXML_NODE *pNode, LPCTSTR lpszAttrName, bool bVal);
    ...
    static BOOL SetAttrib(DVXML_NODE *pNode, LPCTSTR lpszAttrName, double dReturn);
